...
import { Text, SafeAreaView, Image, StyleSheet, FlatList,Alert } from "react-native";
...
export default class Kosu extends React.Component {
    ...
    constructor(props) {
        ...
        super(props);
        this.state = {sonuc:0,
            kalori: 0, kilo: 0,dakika: 0, kilo2: 0,
            content: false,
            contents: true,
            checkbox: false
        };
    ...
    render() {
        ...
        var kilo = this.state.kilo;
        var kilo2 = this.state.kilo;
        var dakika = this.state.dakika;
        const sonuc1 =  (kalori * 200) / (kilo * 6 * 3.5);
            ...
            <SafeAreaView>
               ...
               {   this.state.contents ?     
                   ...
                   Kalori Hesapla  </Button>
                        ...
                        />
                        <TextInput label="Kilo" style={{ margin: 10, }}  onChangeText={kilo => this.setState({kilo})}   keyboardType="number-pad"/>
